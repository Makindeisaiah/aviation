...
<!-- Mirrored from jetly-html.vercel.app/main-html/news-details.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 May 2024 14:34:58 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <title> News Details || Jetly || Jetly HTML 5 Template </title>
    <!-- favicons Icons -->
                        ...
                        <div class="news-details__left">
                            ...
                            <div class="news-details__content">
                                <ul class="list-unstyled news-details__meta">
                                    <li><a href="news-details.php"><i class="fas fa-user-circle"></i> Admin</a>
                                    </li>
                                    <li><a href="news-details.php"><i class="fas fa-comments"></i> 2 Comments</a>
                                    </li>
                                </ul>
                                <h3 class="news-details__title">Few reason’s people choose to fly private jet charter
                                </h3>
                            ...
                            <div class="news-details__pagenation-box">
                                <ul class="list-unstyled news-details__pagenation">
                                    <li>Benefits of using our fiber internet services</li>
                            ...
                            <div class="comment-form">
                                ...
                                <form action="https://jetly-html.vercel.app/main-html/assets/inc/sendemail.php" class="comment-one__form contact-form-validated" novalidate="novalidate">
                                    <div class="row">
                                        <div class="col-xl-6">
                        ...
                        <div class="sidebar">
                                    ...
                                    <li>
                                        ...
                                        <div class="sidebar__post-content">
                                            <h3>
                                                ...
                                                <a href="news-details.php">Flight's precautionary landing in dubai</a>
                                            </h3>
                                        </div>
                                    </li>
                                    <li>
                            ...
                            <div class="sidebar__single sidebar__category">
                                ...
                                <ul class="sidebar__category-list list-unstyled">
                                    <li><a href="news-details.php">Private Jet<span class="icon-right-arrow"></span></a>
                                    </li>
                                    <li class="active"><a href="news-details.php">Charter Flights<span class="icon-right-arrow"></span></a></li>
                                    <li><a href="news-details.php">Traveling<span class="icon-right-arrow"></span></a>
                                    </li>
                                    <li><a href="news-details.php">Jet Services<span class="icon-right-arrow"></span></a></li>
                                    <li><a href="news-details.php">Destinations<span class="icon-right-arrow"></span></a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="sidebar__single sidebar__comments">
                                ...
                                <ul class="sidebar__comments-list list-unstyled">
                                    ...
                                    <li>
                                        ...
                                        <div class="sidebar__comments-text-box">
                                            <p> <span>John Doe on</span> Template:</p>
                                            <h5>Comments</h5>
                                        </div>
                                    </li>
                                    <li>
...
<!-- Mirrored from jetly-html.vercel.app/main-html/news-details.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 May 2024 14:35:00 GMT -->
